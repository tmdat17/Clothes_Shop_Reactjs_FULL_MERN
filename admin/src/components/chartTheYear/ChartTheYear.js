...
const ChartTheYear = ({ aspect, title, yearProp }) => {
        ...
        OrderService.getAllOrder()
            .then((res) => {
                ...
                res.data.map((item) => {
                    ...
                    } else if (month === "02" && year === yearProp) {
                        let money = String(item.totalPrice);
                        money = money.split("");
                        let result = "";
                        for (let i = 0; i < money.length - 4; i++) {
                    ...
                    } else if (month === "03" && year === yearProp) {
                        let money = String(item.totalPrice);
                        money = money.split("");
                        let result = "";
                        for (let i = 0; i < money.length - 4; i++) {
                    ...
                    } else if (month === "04" && year === yearProp) {
                        let money = String(item.totalPrice);
                        money = money.split("");
                        let result = "";
                        for (let i = 0; i < money.length - 4; i++) {
                    ...
                    } else if (month === "05" && year === yearProp) {
                        let money = String(item.totalPrice);
                        money = money.split("");
                        let result = "";
                        for (let i = 0; i < money.length - 4; i++) {
                    ...
                    } else if (month === "06" && year === yearProp) {
                        let money = String(item.totalPrice);
                        money = money.split("");
                        let result = "";
                        for (let i = 0; i < money.length - 4; i++) {
                    ...
                    } else if (month === "07" && year === yearProp) {
                        let money = String(item.totalPrice);
                        money = money.split("");
                        let result = "";
                        for (let i = 0; i < money.length - 4; i++) {
                    ...
                    } else if (month === "08" && year === yearProp) {
                        let money = String(item.totalPrice);
                        money = money.split("");
                        let result = "";
                        for (let i = 0; i < money.length - 4; i++) {
                    ...
                    } else if (month === "09" && year === yearProp) {
                        let money = String(item.totalPrice);
                        money = money.split("");
                        let result = "";
                        for (let i = 0; i < money.length - 4; i++) {
                    ...
                    } else if (month === "10" && year === yearProp) {
                        let money = String(item.totalPrice);
                        money = money.split("");
                        let result = "";
                        for (let i = 0; i < money.length - 4; i++) {
                    ...
                    } else if (month === "11" && year === yearProp) {
                        let money = String(item.totalPrice);
                        money = money.split("");
                        let result = "";
                        for (let i = 0; i < money.length - 4; i++) {
                    ...
                    } else if (month === "12" && year === yearProp) {
                        let money = String(item.totalPrice);
                        money = money.split("");
                        let result = "";
                        for (let i = 0; i < money.length - 4; i++) {
